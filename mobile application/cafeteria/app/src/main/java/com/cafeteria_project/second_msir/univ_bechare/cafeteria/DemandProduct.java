...
public class DemandProduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    btrc.setContext(act);
                    URL = "http://" + IP + ":" + PORT + "/cafeteria/registerCommand.php";
        ...
        URL = "http://" + IP + ":" + PORT + "/cafeteria/recuperatListProduct.php";
    ...
    class Adapter2 extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            price.setText("" + aryPrice.get(position) + " DA");
